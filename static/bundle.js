! function(e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ?
    define(["exports"], t) : t(e.Datafeeds = {})
}(this, function(e) {
  "use strict";
        ...
        if ("ok" === e.s || "no_data" === e.s) {
          ...
          if ("no_data" === e.s) r.noData = !0, r.nextTime = e.nextTime;
            ...
            for (var s = void 0 !== e.v, o = void 0 !== e.o, i = 0; i < e.t.length; ++i) {
              ...
              o && (n.open = Number(e.o[i]), n.high = Number(e.h[i]), n.low = Number(e.l[i])), s && (n.volume =
                Number(e.v[i])), t.push(n)
            }
            /*console.log('-----------------f:', f)
            if (f) {
              t.shift();
  ...
  var a = (o.prototype.subscribeBars = function(e, t, r, s) {
    this._subscribers.hasOwnProperty(s) ? n("DataPulseProvider: already has subscriber with id=" + s) : (this._subscribers[
      s] = {
      lastBarTime: null,
      listener: r,
      resolution: t,
    ...
    if (!(0 < this._requestsPending)) {
      ...
      var e = function(t) {
          s._requestsPending += 1, s._updateDataForSubscriber(t).then(function() {
            r._requestsPending -= 1, n("DataPulseProvider: data for #" + t +
              " updated successfully, pending=" + r._requestsPending)
          }).catch(function(e) {
            r._requestsPending -= 1, n("DataPulseProvider: data for #" + t + " updated with error=" + c(e) +
              ", pending=" + r._requestsPending)
          })
        },
        s = this;
  ...
  function o(e, t) {
    this._subscribers = {}, this._requestsPending = 0, this._historyProvider = e, setInterval(this._updateData.bind(
      this), t)
  }
    ...
    if (!(0 < this._requestsPending)) {
      var e = function(t) {
          ...
          i._quotesProvider.getQuotes(1 === s ? r.fastSymbols : r.symbols).then(function(e) {
            o._requestsPending--, o._subscribers.hasOwnProperty(t) && (r.listener(e), n(
              "QuotesPulseProvider: data for #" + t + " (" + s + ") updated successfully, pending=" + o._requestsPending
            ))
          }).catch(function(e) {
            o._requestsPending--, n("QuotesPulseProvider: data for #" + t + " (" + s +
              ") updated with error=" + c(e) + ", pending=" + o._requestsPending)
          })
        },
        i = this;
      for (var t in this._subscribers) e(t)
  ...
  function l(e) {
    this._subscribers = {}, this._requestsPending = 0, this._quotesProvider = e, setInterval(this._updateQuotes.bind(
      this, 1), 1e4), setInterval(this._updateQuotes.bind(this, 0), 6e4)
  }
  ...
  var h = (f.prototype.resolveSymbol = function(t) {
    ...
    try {
      ...
      throw new Error("SymbolsStorage: API error when processing exchange " + t + " symbol #" + s + " (" + r.symbol[
        s] + "): " + e.message)
    }
  }, f);

  function f(e, t, r) {
    this._exchangesList = ["NYSE", "FOREX", "AMEX"], this._symbolsInfo = {}, this._symbolsList = [], this._datafeedUrl =
      e, this._datafeedSupportedResolutions = t, this._requester = r, this._readyPromise = this._init(), this._readyPromise
      .catch(function(e) {
  ...
  var m = (b.prototype.onReady = function(e) {
    ...
    if (this._configuration.supports_search) {
      ...
      if (null === this._symbolsStorage) throw new Error(
    ...
    if (this._configuration.supports_group_request) {
      ...
      this._send("symbols", i).then(function(e) {
        // void 0 !== e.s ? r("unknown_symbol") : o(Object.assign({ pricescale: 100, volume_precision:2 }, e) )
        e.pricescale = 100; e.volume_precision=2;
    ...
    !e.supports_group_request && e.supports_search || (this._symbolsStorage = new h(this._datafeedURL, e.supported_resolutions ||
      [], this._requester)), n("UdfCompatibleDatafeed: Initialized with " + JSON.stringify(e))
  }, b);
  ...
  function b(e, t, r, s) {
    ...
    this._configuration = {
		...
		volume_precision:2,
      }, this._symbolsStorage = null, this._datafeedURL = e, this._requester = r, this._historyProvider = new i(e,
        this._requester), this._quotesProvider = t, this._dataPulseProvider = new a(this._historyProvider, s), this._quotesPulseProvider =
      new u(this._quotesProvider), this._configurationReadyPromise = this._requestConfiguration().then(function(e) {
        null === e && (e = {
          supports_search: !1,
          supports_group_request: !0,
          supported_resolutions: ["1", "5", "15", "30", "60", "1D", "1W", "1M"],
  ...
  var q, w, D, S = (t(q = k, w = D = m), void(q.prototype = null === w ? Object.create(w) : (x.prototype = w.prototype,
    new x)), k);
